...
rem curl -i -X GET http://localhost:8080/cassandra/api/prj
 ...
 curl -i --data @C:\workspace\platform\tests\TestAHouseScenario\washingmachine.json --header Content-type:application/json http://localhost:8080/cassandra/api/app
