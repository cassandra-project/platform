/*
 * File: app/store/Demographics.js
 *
...
Ext.define('C.store.Demographics', {
	...
	onJsonstoreUpdate: function(store, record, operation, modifiedFieldNames, eOpts) {
		console.info('Demographic data updated.', store, record, operation, eOpts);
		if (!record.node) {
			if (operation == 'commit') {
