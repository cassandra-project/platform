/*
 * File: app/view/ActivitiesGrid.js
 *
...
Ext.define('C.view.ActivitiesGrid', {
	...
	onGriddragdroppluginBeforeDrop: function(node, data, overModel, dropPosition, dropFunction, options) {
		...
		*/
		...
		if('C.model.'+data.records[0].get('nodeType')==this.store.model.modelName){
			...
			this.store.add({
				'pers_id': this.store.navigationNode.parentNode.data.id,
				'name': node.get('name'),
				'type': node.get('type'),
	...
	onButtonClick: function(button, e, options) {
		...
		var pers_id = this.store.navigationNode.parentNode.get('id');
		this.store.insert(0, new C.model.Activity({pers_id: pers_id}));
