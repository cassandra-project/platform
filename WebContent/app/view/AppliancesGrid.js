/*
 * File: app/view/AppliancesGrid.js
 *
...
Ext.define('C.view.AppliancesGrid', {
	...
	onGriddragdroppluginBeforeDrop: function(node, data, overModel, dropPosition, dropFunction, options) {
		...
		*/
		...
		if('C.model.'+data.records[0].get('nodeType')==this.store.model.modelName){
			...
			data.copy = true;
			this.store.add({
				'inst_id': this.store.navigationNode.parentNode.data.id,
				'name': node.get('name'),
	...
	onButtonClick: function(button, e, options) {
		...
		var inst_id = this.store.navigationNode.parentNode.get('id');
		this.store.insert(0, new C.model.Appliance({inst_id: inst_id}));
