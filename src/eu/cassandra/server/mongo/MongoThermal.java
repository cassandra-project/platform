...
public class MongoThermal {
	public final static String COL_THERMAL = "thermal";
	...
	public String get(HttpHeaders httpHeaders,String id) {
		return new MongoDBQueries().getEntity(httpHeaders, COL_THERMAL,"_id", 
				id, "Thermal params retrieved successfully").toString();
	}
	...
	public String delete(String id) {
		return new MongoDBQueries().deleteDocument(COL_THERMAL, id).toString();
	}
	...
	public String update(String id,String jsonToUpdate) {
		...
		String returnMsg = q.updateDocument("_id", id,jsonToUpdate,
				COL_THERMAL, "Thermal params updated successfully",
				MongoInstallations.COL_INSTALLATIONS ,"inst_id",JSONValidator.THERMAL_SCHEMA).toString();
		return returnMsg;
	}
