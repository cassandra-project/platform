...
public class PricingPolicies {
	...
	@POST
	public Response createPricingPolicy(String message) {
		return Utils.returnResponse(PrettyJSONPrinter.prettyPrint(new MongoPricingPolicy().createPricingPolicy(message)));
	}
