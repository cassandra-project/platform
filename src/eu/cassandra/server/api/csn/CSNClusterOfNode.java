...
public class CSNClusterOfNode {
	...
	@GET
	public Response getClusterID(@QueryParam("csnnode_id") String csnnode_id, @QueryParam("clusters_id") String clusters_id){
		if(csnnode_id != null ) {
			String filters = null;
			if(clusters_id != null)
				filters = "{\"clustersid\":\"" + clusters_id + "\"}";
			String r = PrettyJSONPrinter.prettyPrint(
					new MongoDBQueries().getEntity((HttpHeaders)null, MongoGraphs.COL_CSN_NODES2CLUSTERS,"node_id",csnnode_id,filters,null,0, 0, 
