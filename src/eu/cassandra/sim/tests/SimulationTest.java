...
public class SimulationTest {
	...
	public void SimulationTest() throws Exception {
		...
		Appliance app1=new Appliance.Builder("Appid1","App1", "App1Desc", "App1Type", inst1, new ConsumptionModel(scenario, "p"), null, 1f, true, true, null).build(new ORNG());
		Appliance app2=new Appliance.Builder("Appid2","App2", "App2Desc", "App2Type", inst1, new ConsumptionModel(scenario, "p"), null, 1f, true, true, null).build(new ORNG());
